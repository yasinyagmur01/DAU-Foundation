...
- **Son D-kaydı: D-139.** Sıradaki kayıt **D-140** olarak açılır.
- 📄 **DR #12 yazıldı, gönderilmedi** — `docs/research/2026-08-19_price-sensitivity-and-seed-budget_PLAIN.txt`
