...
- Docs: yalnızca `DAU_MASTER_REFERENCE_v15.{md,html,pdf}` (içerik v1.6).
...
docs/
 └── DAU_MASTER_REFERENCE_v15.{md,html,pdf}  — operasyonel kaynak (içerik v1.6)
```
...
- ⚠️ Parametrik plastisite / yaşantı-LoRA (**v1.6 durumu**):
  ...
  - Detay: §18 Plastisite günlüğü (bu Master).
...
- Docs: yalnızca bu Master `v15.{md,html,pdf}`
